Shader "Custom/TrueNormal_Metallic"
{

	// "true normal" shading code courtesy of hextantstudios.com
	// http://www.hextantstudios.com/unity-flat-low-poly-shader/
	...
	SubShader
	{
			...
			out half4 outEmission : SV_Target3)
		{
			...
			// We need to get the "true" normal in order to make our geometry shade as straight lines between vertices
